...
<%@ taglib prefix="ex" uri="/taglib/congratulationTagLib.tld" %>
<fmx:setBundle basename="locale.usual.enroll_applicants" var="enrollMenuB"/>
            ...
            <div class="table-actions">
                <c:forEach items="${mapFaculty}" var="map">
                    <div class="display-table-inline">
                        <h3><fmx:message bundle="${enrollMenuB}" key="faculty.${map.key.name}"/> (${map.key.name})</h3>
                        <table>
                            <tr>
                                <th>№</th>
                            ...
                            <c:forEach items="${map.value}" var="statementDto" varStatus="i">
                                <tr>
                                    <td><c:out value = "${i.count}"/></td>
                                    <td><c:out value="${statementDto.user.secondName} ${statementDto.user.firstName}"></c:out></td>
